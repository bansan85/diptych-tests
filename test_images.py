...
def test_image_failed_to_rotate_png() -> None:
    ...
    treat_file(
        "image_failed_to_rotate.png",
        {
            ...
            ConstString.image_crop(1, "x1"): (194, "range", -1, 1),
            ConstString.image_crop(1, "y1"): (9, "range", -1, 1),
            ConstString.image_crop(1, "x2"): (2439, "range", -1, 1),
            ConstString.image_crop(1, "y2"): (3453, "range", -1, 1),
            ...
            ConstString.image_dpi(1): (300, "difference", 0.0000001),
            ConstString.image_border(1, 1): (32, "range", -1, 1),
            ConstString.image_border(1, 2): (32, "range", -1, 1),
            ConstString.image_border(1, 3): (118, "range", -1, 1),
            ConstString.image_border(1, 4): (118, "range", -1, 1),
            ConstString.image_dpi(2): (300, "difference", 0.0000001),
