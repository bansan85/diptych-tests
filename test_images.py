...
def test_0001_png() -> None:
    ...
    treat_file(
        "0001.png",
        {
            ...
            ConstString.page_rotation(2): ("range", 0.16, 0.18),
...
def test_2_pages_2_contours_png() -> None:
    ...
    treat_file(
        "2-pages-2-contours.png",
        {
            ...
            ConstString.page_rotation(1): ("range", 0.08, 0.09),
            ConstString.page_rotation(2): ("range", 0.25, 0.26),
            ConstString.image_crop(1, "x1"): ("range", 1185, 1185),
            ConstString.image_crop(1, "y1"): ("range", 1720, 1720),
            ConstString.image_crop(1, "x2"): ("range", 1186, 1186),
            ConstString.image_crop(1, "y2"): ("range", 1721, 1721),
            ConstString.image_crop(2, "x1"): ("range", 108, 108),
            ConstString.image_crop(2, "y1"): ("range", 241, 241),
            ConstString.image_crop(2, "x2"): ("range", 2154, 2154),
            ConstString.image_crop(2, "y2"): ("range", 3240, 3240),
            ConstString.image_dpi(1): ("difference", 300, 0.0000001),
            ...
            ConstString.image_dpi(2): ("difference", 300, 0.0000001),
            ConstString.image_border(2, 1): ("range", 240, 240),
            ConstString.image_border(2, 2): ("range", 248, 248),
...
def test_black_border_not_removed_png() -> None:
    ...
    treat_file(
        "black-border-not-removed.png",
        {
            ...
            ConstString.page_rotation(1): ("range", 0.01, 0.02),
            ConstString.page_rotation(2): ("range", -0.2, -0.1),
            ConstString.image_crop(1, "x1"): ("range", 298, 298),
            ConstString.image_crop(1, "y1"): ("range", 143, 143),
            ...
            ConstString.image_crop(2, "y1"): ("range", 144, 144),
            ConstString.image_crop(2, "x2"): ("range", 2172, 2172),
            ConstString.image_crop(2, "y2"): ("range", 3353, 3353),
            ConstString.image_dpi(1): ("difference", 300, 0.0000001),
            ConstString.image_border(1, 1): ("range", 127, 127),
            ConstString.image_border(1, 2): ("range", 157, 157),
            ConstString.image_border(1, 3): ("range", 225, 225),
            ConstString.image_border(1, 4): ("range", 225, 225),
            ConstString.image_dpi(2): ("difference", 300, 0.0000001),
            ConstString.image_border(2, 1): ("range", 132, 132),
...
def test_image_failed_to_rotate_png() -> None:
    ...
    treat_file(
        "image_failed_to_rotate.png",
        {
            ...
            ConstString.separation_double_page_y(): ("range", 2487, 2487),
            ConstString.page_rotation(1): ("range", 0.39, 0.40),
            ConstString.page_rotation(2): ("range", 0.36, 0.37),
            ConstString.image_crop(1, "x1"): ("range", 77, 77),
            ConstString.image_crop(1, "y1"): ("range", 8, 8),
            ConstString.image_crop(1, "x2"): ("range", 2481, 2481),
            ConstString.image_crop(1, "y2"): ("range", 3486, 3486),
            ConstString.image_crop(2, "x1"): ("range", 170, 170),
            ConstString.image_crop(2, "y1"): ("range", 234, 234),
            ConstString.image_crop(2, "x2"): ("range", 2251, 2251),
            ConstString.image_crop(2, "y2"): ("range", 3356, 3356),
            ConstString.image_dpi(1): ("difference", 300, 0.0000001),
            ConstString.image_border(1, 1): ("range", 15, 15),
            ConstString.image_border(1, 2): ("range", 15, 15),
            ConstString.image_border(1, 3): ("range", 38, 38),
            ConstString.image_border(1, 4): ("range", 38, 38),
            ConstString.image_dpi(2): ("difference", 300, 0.0000001),
            ConstString.image_border(2, 1): ("range", 206, 206),
            ConstString.image_border(2, 2): ("range", 159, 159),
            ConstString.image_border(2, 3): ("range", 189, 189),
            ConstString.image_border(2, 4): ("range", 189, 189),
        },
    )
