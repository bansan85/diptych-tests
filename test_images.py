...
def test_black_border_not_removed_png() -> None:
    ...
    MockDisableSeparatePage(MAX_VAL, FUZZING).treat_file(
        ...
        ),
        {
            ...
            ConstString.image_crop(1, "x2"): ("range", 2306, 2312),
            ConstString.image_crop(1, "y2"): ("range", 3345, 3348),
            ConstString.image_crop(2, "x1"): ("range", 155, 159),
            ...
            ConstString.image_dpi(1): ("difference", 300, 0.0000001),
            ConstString.image_border(1, 1): ("range", 127, 136),
...
def test_image_failed_to_rotate_png() -> None:
    ...
    MockDisableSeparatePage(MAX_VAL, FUZZING).treat_file(
        get_absolute_from_current_path(__file__, "image_failed_to_rotate.png"),
        {
            ...
            ConstString.image_crop(1, "x1"): ("range", 28, 91),
            ...
            ConstString.image_border(1, 3): ("range", 15, 55),
            ConstString.image_border(1, 4): ("range", 15, 55),
            ConstString.image_dpi(2): ("difference", 300, 0.0000001),
...
def test_wrong_angle_split_line_png() -> None:
    ...
    MockDisableSeparatePage(MAX_VAL, FUZZING).treat_file(
        get_absolute_from_current_path(__file__, "wrong_angle_split_line.png"),
        {
            ...
            ConstString.image_crop(1, "x1"): ("range", 41, 61),
            ...
            ConstString.image_border(1, 3): ("range", 23, 33),
            ConstString.image_border(1, 4): ("range", 23, 33),
            ConstString.image_dpi(2): ("difference", 300, 0.0000001),
...
def test_wrong_split_line_png() -> None:
    ...
    MockDisableSeparatePage(MAX_VAL, FUZZING).treat_file(
        get_absolute_from_current_path(__file__, "wrong_split_line.png"),
        {
            ...
            ConstString.image_crop(2, "y1"): ("range", 164, 167),
            ConstString.image_crop(2, "x2"): ("range", 2235, 2238),
            ConstString.image_crop(2, "y2"): ("range", 3372, 3375),
            ConstString.image_dpi(1): ("difference", 300, 0.0000001),
            ...
            ConstString.image_border(2, 2): ("range", 133, 152),
            ConstString.image_border(2, 3): ("range", 173, 174),
            ConstString.image_border(2, 4): ("range", 173, 174),
        },
    )
...
def test_crop_too_much_png() -> None:
    ...
    MockDisableSeparatePage(MAX_VAL, FUZZING).treat_file(
        get_absolute_from_current_path(__file__, "crop_too_much.png"),
        {
            ...
            ConstString.image_crop(1, "y2"): ("range", 3350, 3352),
            ...
            ConstString.image_border(2, 2): ("range", 141, 186),
...
def test_crop_too_few_png() -> None:
    ...
    MockDisableSeparatePage(MAX_VAL, FUZZING).treat_file(
        get_absolute_from_current_path(__file__, "crop_too_few.png"),
        {
            ...
            ConstString.image_crop(2, "x1"): ("range", 132, 141),
            ConstString.image_crop(2, "y1"): ("range", 139, 141),
            ConstString.image_crop(2, "x2"): ("range", 2258, 2263),
            ConstString.image_crop(2, "y2"): ("range", 3344, 3347),
            ConstString.image_dpi(1): ("difference", 300, 0.0000001),
            ConstString.image_border(1, 1): ("range", 84, 135),
            ...
            ConstString.image_dpi(2): ("difference", 300, 0.0000001),
            ConstString.image_border(2, 1): ("range", 127, 143),
...
def test_crop_too_much_2_png() -> None:
    ...
    MockDisableSeparatePage(MAX_VAL, FUZZING).treat_file(
        get_absolute_from_current_path(__file__, "crop_too_much_2.png"),
        {
            ...
            ConstString.image_crop(2, "x1"): ("range", 159, 169),
            ConstString.image_crop(2, "y1"): ("range", 137, 139),
            ConstString.image_crop(2, "x2"): ("range", 2175, 2182),
            ConstString.image_crop(2, "y2"): ("range", 3345, 3346),
            ConstString.image_dpi(1): ("difference", 300, 0.0000001),
            ConstString.image_border(1, 1): ("range", 112, 127),
            ConstString.image_border(1, 2): ("range", 160, 170),
...
def test_small_wave_png() -> None:
    ...
    MockDisableSeparatePage(MAX_VAL, FUZZING).treat_file(
        get_absolute_from_current_path(__file__, "small_wave.png"),
        {
            ...
            ConstString.image_crop(1, "x1"): ("range", 317, 324),
            ConstString.image_crop(1, "y1"): ("range", 197, 199),
            ConstString.image_crop(1, "x2"): ("range", 2351, 2355),
            ConstString.image_crop(1, "y2"): ("range", 3393, 3395),
            ConstString.image_crop(2, "x1"): ("range", 128, 139),
            ...
            ConstString.image_dpi(1): ("difference", 300, 0.0000001),
            ConstString.image_border(1, 1): ("range", 174, 181),
            ConstString.image_border(1, 2): ("range", 111, 116),
            ConstString.image_border(1, 3): ("range", 211, 215),
            ConstString.image_border(1, 4): ("range", 211, 215),
            ConstString.image_dpi(2): ("difference", 300, 0.0000001),
            ConstString.image_border(2, 1): ("range", 191, 199),
            ConstString.image_border(2, 2): ("range", 87, 102),
...
def test_wrong_split_line_3_png() -> None:
    ...
    MockDisableSeparatePage(MAX_VAL, FUZZING).treat_file(
        get_absolute_from_current_path(__file__, "wrong_split_line_3.png"),
        {
            ...
            ConstString.image_crop(2, "x1"): ("range", 100, 104),
            ConstString.image_crop(2, "y1"): ("range", 206, 209),
            ConstString.image_crop(2, "x2"): ("range", 2132, 2136),
            ...
            ConstString.image_border(2, 2): ("range", 89, 95),
            ConstString.image_border(2, 3): ("range", 212, 215),
            ConstString.image_border(2, 4): ("range", 212, 215),
        },
    )
...
def test_wrong_wave_split_line_png() -> None:
    ...
    MockDisableSeparatePage(MAX_VAL, FUZZING).treat_file(
        get_absolute_from_current_path(__file__, "wrong_wave_split_line.png"),
        {
            ...
            ConstString.image_crop(1, "x1"): ("range", 384, 385),
            ...
            ConstString.image_border(1, 3): ("range", 216, 217),
            ConstString.image_border(1, 4): ("range", 216, 217),
            ConstString.image_dpi(2): ("difference", 300, 0.0000001),
...
def test_no_split_line_line_algo_png() -> None:
    ...
    MockDisableSeparatePage(MAX_VAL, FUZZING).treat_file(
        ...
        ),
        {
            ...
            ConstString.image_crop(1, "x2"): ("range", 2320, 2322),
...
def test_failed_split_line_line_algo_png() -> None:
    ...
    MockDisableSeparatePage(MAX_VAL, FUZZING).treat_file(
        ...
        ),
        {
            ...
            ConstString.image_crop(1, "x1"): ("range", 407, 413),
            ConstString.image_crop(1, "y1"): ("range", 2925, 2928),
            ConstString.image_crop(1, "x2"): ("range", 2419, 2425),
            ConstString.image_crop(1, "y2"): ("range", 3171, 3174),
            ConstString.image_crop(2, "x1"): ("range", 1180, 1190),
            ConstString.image_crop(2, "y1"): ("range", 1724, 1748),
            ConstString.image_crop(2, "x2"): ("range", 1181, 1191),
...
def test_crop_too_much_3_png() -> None:
    ...
    MockDisableSeparatePage(MAX_VAL, FUZZING).treat_file(
        get_absolute_from_current_path(__file__, "crop_too_much_3.png"),
        {
            ...
            ConstString.image_crop(1, "x1"): ("range", 371, 375),
            ConstString.image_crop(1, "y1"): ("range", 257, 258),
            ConstString.image_crop(1, "x2"): ("range", 2385, 2388),
            ConstString.image_crop(1, "y2"): ("range", 3458, 3460),
            ConstString.image_crop(2, "x1"): ("range", 165, 172),
            ConstString.image_crop(2, "y1"): ("range", 228, 229),
            ConstString.image_crop(2, "x2"): ("range", 2180, 2185),
            ConstString.image_crop(2, "y2"): ("range", 3416, 3417),
            ConstString.image_dpi(1): ("difference", 300, 0.0000001),
            ConstString.image_border(1, 1): ("range", 237, 239),
            ConstString.image_border(1, 2): ("range", 45, 50),
            ConstString.image_border(1, 3): ("range", 221, 224),
            ConstString.image_border(1, 4): ("range", 221, 224),
            ConstString.image_dpi(2): ("difference", 300, 0.0000001),
...
def test_wrong_wave_split_line_2_png() -> None:
    ...
    MockDisableSeparatePage(MAX_VAL, FUZZING).treat_file(
        ...
        ),
        {
            ...
            ConstString.image_dpi(2): ("difference", 300, 0.0000001),
            ConstString.image_border(2, 1): ("range", 165, 172),
            ConstString.image_border(2, 2): ("range", 115, 121),
            ConstString.image_border(2, 3): ("range", 167, 169),
            ConstString.image_border(2, 4): ("range", 167, 169),
        },
    )
...
def test_no_split_line_wave_algo_png() -> None:
    ...
    MockDisableSeparatePage(MAX_VAL, FUZZING).treat_file(
        ...
        ),
        {
            ...
            ConstString.image_crop(1, "x1"): ("range", 96, 101),
            ConstString.image_crop(1, "y1"): ("range", 27, 81),
            ...
            ConstString.image_dpi(1): ("difference", 300, 0.0000001),
            ConstString.image_border(1, 1): ("range", 15, 42),
            ConstString.image_border(1, 2): ("range", 15, 42),
            ConstString.image_border(1, 3): ("range", 39, 52),
            ConstString.image_border(1, 4): ("range", 39, 52),
            ConstString.image_dpi(2): ("difference", 300, 0.0000001),
            ConstString.image_border(2, 1): ("range", 252, 265),
            ConstString.image_border(2, 2): ("range", 106, 120),
...
def test_crop_too_few_2_png() -> None:
    ...
    MockDisableSeparatePage(MAX_VAL, FUZZING).treat_file(
        get_absolute_from_current_path(__file__, "crop_too_few_2.png"),
        {
            ...
            ConstString.image_crop(1, "x2"): ("range", 2396, 2402),
            ConstString.image_crop(1, "y2"): ("range", 3367, 3369),
            ...
            ConstString.image_border(1, 2): ("range", 126, 145),
            ConstString.image_border(1, 3): ("range", 173, 175),
            ConstString.image_border(1, 4): ("range", 173, 175),
            ConstString.image_dpi(2): ("difference", 300, 0.0000001),
            ConstString.image_border(2, 1): ("range", 174, 181),
...
def test_failed_detect_rectangle_png() -> None:
    ...
    MockDisableSeparatePage(MAX_VAL, FUZZING).treat_file(
        ...
        ),
        {
            ...
            ConstString.image_dpi(2): ("difference", 300, 0.0000001),
            ConstString.image_border(2, 1): ("range", 199, 204),
...
def test_single_page_png() -> None:
    ...
    MockDisableSeparatePage(MAX_VAL, FUZZING).treat_file(
        get_absolute_from_current_path(__file__, "single_page.png"),
        {
            ...
            ConstString.image_crop(1, "y2"): ("range", 3501, 3505),
            ...
            ConstString.image_border(1, 1): ("range", 5, 8),
            ConstString.image_border(1, 2): ("range", 5, 8),
            ConstString.image_border(1, 3): ("range", 6, 10),
            ConstString.image_border(1, 4): ("range", 6, 10),
            ConstString.image_dpi(2): ("difference", 300, 0.0000001),
...
def test_no_split_line_wave_algo_3_png() -> None:
    ...
    MockDisableSeparatePage(MAX_VAL, FUZZING).treat_file(
        ...
        ),
        {
            ...
            ConstString.image_crop(1, "x1"): ("range", 182, 189),
            ConstString.image_crop(1, "y1"): ("range", 2955, 2960),
            ConstString.image_crop(1, "x2"): ("range", 2199, 2206),
...
def test_wrong_split_line_4_png() -> None:
    ...
    MockDisableSeparatePage(MAX_VAL, FUZZING).treat_file(
        get_absolute_from_current_path(__file__, "wrong_split_line_4.png"),
        {
            ...
            ConstString.image_crop(2, "y1"): ("range", 330, 331),
            ConstString.image_crop(2, "x2"): ("range", 2313, 2316),
            ConstString.image_crop(2, "y2"): ("range", 3217, 3219),
            ConstString.image_dpi(1): ("difference", 300, 0.0000001),
            ...
            ConstString.image_dpi(2): ("difference", 300, 0.0000001),
            ConstString.image_border(2, 1): ("range", 322, 323),
            ConstString.image_border(2, 2): ("range", 276, 278),
